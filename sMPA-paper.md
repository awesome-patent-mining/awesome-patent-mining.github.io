...
**Table A2**   A list of basic patents appearing along path 1 when β=0.05
...
**Table A3**   A list of basic patents appearing along path 2 when β=0.05
...
**Table A4**   A list of basic patents appearing along path 3 when β=0.05
...
**Table A5**   A list of basic patents appearing along path 4 when β=0.05
